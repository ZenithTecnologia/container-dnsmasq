...
if [ "${DHCP}" = true ] ; then
    ...
    DNSMASQ_DHCP_DOMAINNAME_OPTION="dhcp-option-force=15,${DNS_LOCAL_DOMAIN:-local}"
    DNSMASQ_DHCP_DOMAINNAME_SEARCH_OPTION="dhcp-option-force=119,${DNS_LOCAL_DOMAIN:-local}"
